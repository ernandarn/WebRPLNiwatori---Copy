...
namespace WebRPLNiwatori.Controllers
{
    public class Keranjang_BelanjaController : Controller
    {
        ...
        //public ActionResult Ubah(int id)
        //{
        //    using (Keranjang_BelanjaDAL sc = new Keranjang_BelanjaDAL())
        //    {
        //        var shop = sc.GetItemByID(id);
        //        return View(shop);
        //    }
        //}

        //[HttpPost, ActionName("Ubah")]
        //public ActionResult UbahPost(Keranjang_Belanja id)
        //{
        ...
        //        {
        //            service.Ubah(id);
        //            TempData["Pesan"] = Helpers.Pesan.getPesan("Sukses!", "success", "Data " + id.Qty + " berhasil diubah");
        //        }
        //        catch (Exception ex)
        //        {
