...
namespace WebRPLNiwatori.DAL
{
    public class Keranjang_BelanjaDAL : IDisposable
    {
        ...
        public Keranjang_Belanja GetItemByUser(string username, int id)
        {
            var result = (from s in db.Keranjang_Belanja
                          where s.Username == username && s.Kode_Barang == id
        ...
        //public void Ubah(Keranjang_Belanja id)
        //{
        //    var result = GetItemByID(id.Id_Cart);
        //    if (result != null)
        //    {
        //        result.Qty = id.Qty;
        //        db.SaveChanges();
